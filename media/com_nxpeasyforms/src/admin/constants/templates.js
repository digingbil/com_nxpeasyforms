...
export const FORM_TEMPLATES = [
    ...
    {
        id: 'woocommerce-product-order',
        name: __('Product Order Form', 'nxp-easy-forms'),
        description: __(
            'Collect customer and billing details for WooCommerce orders. Configure products in WooCommerce integration settings.',
            'nxp-easy-forms'
        ),
        fields: [
            {
            ...
            },
            {
                ...
                label: __('Street Address', 'nxp-easy-forms'),
                required: true,
            },
            {
                type: 'text',
                name: 'billing_city',
                label: __('City', 'nxp-easy-forms'),
                required: true,
            },
            {
                type: 'country',
            ...
            },
            {
                ...
                label: __('Postal Code', 'nxp-easy-forms'),
                required: true,
            },
            {
                type: 'textarea',
                name: 'order_notes',
                label: __('Order Notes (Optional)', 'nxp-easy-forms'),
                required: false,
                placeholder: __(
            ...
            {
                type: 'button',
                label: __('Place Order', 'nxp-easy-forms'),
            },
        ],
        options: {
            success_message: __(
    ...
    {
        id: 'woocommerce-custom-product',
        name: __('Custom Product Request', 'nxp-easy-forms'),
        description: __(
            'Custom product order with specifications for WooCommerce. Configure products in integration settings.',
            'nxp-easy-forms'
        ),
        fields: [
            {
            ...
            },
            {
                type: 'text',
                name: 'company',
                label: __('Company Name (Optional)', 'nxp-easy-forms'),
                required: false,
            },
            {
                type: 'select',
                name: 'product_category',
                label: __('Product Category', 'nxp-easy-forms'),
                required: true,
                options: [
                    __('Custom T-Shirts', 'nxp-easy-forms'),
                    __('Personalized Mugs', 'nxp-easy-forms'),
                    __('Custom Posters', 'nxp-easy-forms'),
                    __('Other (describe below)', 'nxp-easy-forms'),
                ],
            },
            {
                type: 'textarea',
                name: 'specifications',
                label: __('Product Specifications', 'nxp-easy-forms'),
                required: true,
                placeholder: __(
                    'Describe your custom product: size, color, design preferences, quantity needed, etc.',
                    'nxp-easy-forms'
                ),
            },
            {
                type: 'file',
                name: 'design_file',
                label: __('Upload Design/Reference (Optional)', 'nxp-easy-forms'),
                required: false,
            ...
            },
            {
                type: 'date',
                name: 'delivery_date',
                label: __('Desired Delivery Date', 'nxp-easy-forms'),
                required: false,
            },
            {
                type: 'textarea',
                name: 'special_instructions',
                label: __('Special Instructions', 'nxp-easy-forms'),
                required: false,
                placeholder: __(
            ...
            },
            {
                ...
                name: 'quote_approval',
                label: __(
                    'I understand that I will receive a quote before processing',
                    'nxp-easy-forms'
                ),
                required: true,
            },
            {
                type: 'button',
                label: __('Submit Custom Order Request', 'nxp-easy-forms'),
            },
        ],
        options: {
            success_message: __(
                'Thank you! We received your custom product request. Our team will review it and send you a quote within 24 hours.',
                'nxp-easy-forms'
            ),
        },
    },
